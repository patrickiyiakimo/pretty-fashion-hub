...
<body class="font-sans antialiased bg-gradient-to-br from-purple-50 to-white">
    ...
    <div class="min-h-screen w-full flex items-center justify-center login-container">
        <div class="w-full min-h-screen bg-white">
            <div class="grid md:grid-cols-2 min-h-screen">
                ...
                <div class="flex items-center justify-center bg-gradient-to-br from-pink-50 to-white py-12">
                    <div class="w-full max-w-md px-8">
                        <div class="text-center mb-8">
                            ...
                            <h2 class="text-2xl font-bold text-pink-900 mt-6">Welcome Back!</h2>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" name="email" id="email" value="{{ old('email') }}" required 
                                        class="w-full pl-10 pr-4 py-3 border border-purple-200 focus:outline-none focus:border-pink-400 focus:ring-2 focus:ring-pink-200 transition @error('email') border-red-500 @enderror"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="password" name="password" id="password" required 
                                        class="w-full pl-10 pr-4 py-3 border border-purple-200 focus:outline-none focus:border-pink-400 focus:ring-2 focus:ring-pink-200 transition @error('password') border-red-500 @enderror"
                                        placeholder="••••••••">
                                </div>
                                @error('password')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            ...
                            <div class="flex items-center justify-between">
                                <label class="flex items-center">
                                    <input type="checkbox" name="remember" class="form-checkbox text-pink-800 border-purple-300 focus:ring-pink-800">
                                    <span class="ml-2 text-sm text-gray-600">Remember me</span>
                                </label>
                                <a href="{{ route('password.request') }}" class="text-sm text-pink-600 hover:text-pink-700 font-semibold">Forgot Password?</a>
                            </div>

                            <!-- Submit Button -->
                            <button type="submit" class="w-full bg-gradient-to-r from-pink-900/85 via-pink-800/75 to-pink-900/85 text-white py-3 hover:from-pink-500 hover:to-pink-600 hover:text-pink-900 transition-all duration-300 font-semibold text-lg">
                                Sign In
                            </button>
                            ...
                            <div class="text-center pt-4">
                                <p class="text-gray-600">
                                    ...
                                    <a href="{{ route('register') }}" class="text-pink-700 hover:text-pink-800 font-semibold">Create Account</a>
                                </p>
                            </div>
                        </form>
                    </div>
                ...
                <div class="hidden md:block relative bg-gradient-to-br from-purple-900 to-purple-800 min-h-screen">
