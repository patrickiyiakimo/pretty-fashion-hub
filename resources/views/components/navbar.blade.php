...
<button onclick="shareCartOnWhatsApp()" class="relative p-2 text-pink-200 hover:text-gold-400 transition-all duration-300 hover:scale-110" id="whatsappCartBtn" style="display: none;">
    <svg class="w-5 h-5 md:w-5 md:h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12c0 1.821.487 3.53 1.338 5.001L2 22l5.107-1.088A9.955 9.955 0 0012 22z"/>
    </svg>
    <span id="whatsappCartCount" class="absolute -top-1 -right-1 bg-green-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold shadow-lg">0</span>
</button>
